      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 py-12 text-gray-800 flex flex-col gap-12">
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          ...
          <p className="leading-relaxed">
            The Smart NCO Search Portal provides information for reference purposes only. The portal is maintained by the Ministry of Labour & Employment, Government of India, to assist users in identifying appropriate NCO-2015 occupational codes.
          </p>
        </section>
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          ...
          <p className="leading-relaxed">
            While all reasonable efforts are made to ensure accuracy, the Government of India does not guarantee the completeness, correctness, or reliability of the information provided. Users are responsible for verifying details from official sources before using them for legal, professional, or official purposes.
          </p>
        </section>

        {/* User Responsibilities */}
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          <h2 className="text-2xl font-semibold text-[#0B3B60]">User Responsibilities</h2>
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              <a href="/assets/disclaimer.pdf" download className="underline text-[#0B3B60] hover:text-[#092d48]">
