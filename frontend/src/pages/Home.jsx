...
function Home() {
  ...
  // Chakra manual positioning (unchanged)
  ...
  return (
    <div className="relative min-h-screen w-full bg-gray-50 flex flex-col overflow-hidden font-sans">
...
<section className="relative flex-grow z-10 flex flex-col items-center text-center py-12 px-6 md:px-0 max-w-5xl mx-auto gap-6">
  ...
  >
    ...
    {/* Portal main title */}
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0B3B60] tracking-tight leading-snug">
      Smart NCO Search Portal
    </h1>

    {/* Subheading description */}
    <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl leading-relaxed">
      National Classification of Occupations – 2015. Official portal to identify the appropriate NCO-2015 occupational code for any profession.
    </p>

    {/* Access button */}
    <Link
      to="/search-logs"
      className="mt-3 inline-block bg-[#0B3B60] text-white px-8 py-3 rounded-md font-medium hover:bg-[#092d48] transition-shadow shadow-md"
    >
      Access Search Logs
    </Link>
  </motion.div>

  {/* Search Card with official banner style */}
  <motion.div
  ...
  >
    {/* Optional tricolor stripe at top of card */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-300">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm text-gray-200">
              ...
              <li>
                <a href="https://labour.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-white">
