      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 py-12 text-gray-800 flex flex-col gap-12">
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          ...
          <p className="leading-relaxed text-gray-700">
            The Smart NCO Search Portal respects the privacy of its users. Any personal information collected is handled according to Government of India privacy guidelines and applicable laws.
          </p>
          <p className="leading-relaxed text-gray-700">
        ...
        {/* Data Collection */}
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          <h2 className="text-2xl font-bold text-[#0B3B60]">Data Collection</h2>
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          <h2 className="text-2xl font-bold text-[#0B3B60]">Usage of Information</h2>
          <p className="leading-relaxed text-gray-700">
            We do not share search data with third parties, except as required for official reporting and analysis by the Ministry of Labour & Employment.
          </p>
          <p className="leading-relaxed text-gray-700">
            Data is securely stored and accessible only to authorized personnel for government reporting and statistical analysis.
          </p>
        </section>

        {/* User Rights */}
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          <h2 className="text-2xl font-bold text-[#0B3B60]">User Rights</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Users can request information about the data stored regarding their usage.</li>
        ...
        <section className="bg-white shadow-md border border-gray-200 rounded-md p-6 space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>
              <a href="/assets/privacy_policy.pdf" download className="underline text-[#0B3B60] hover:text-[#092d48] transition-colors">
                Official Privacy Policy (PDF)
              </a>
            </li>
            <li>
